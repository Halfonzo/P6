	                                                    	...
	                                                    	<form action = "" method = "post">
	                                                    		...
	                                                    		<div class="form-row">
	                                                    			<div class="form-group col-md-12">
															            <input name="nombre" type="text" class="form-control" id="inputNombre" placeholder="Nombre completo" value="<?php echo $data[0] ?>">
															    ...
															    <div class="form-row">
															        <div class="form-group col-md-6">
															            <input name="email" type="email" class="form-control" id="inputEmail" placeholder="Email" value="<?php echo $data[2] ?>">
															            <label for="inputEmail" class="col-form-label">Email</label>
															        </div>
															        <div class="form-group col-md-6">
															            <input name="telefono" type="text" class="form-control" id="inputTelefono" placeholder="Telefono" value="<?php echo $data[1] ?>">
